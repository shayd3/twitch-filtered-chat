  ...
  try {
    for (var _iterator = Object.entries(qs_data)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (k === "clientid") {
        ...
        key = "Debug";
        if (v === "debug") val = Util.LEVEL_DEBUG;else if (v === "trace") val = Util.LEVEL_TRACE;else if (typeof v === "number") val = v;else val = Number(Boolean(v));
...
function setNotify() {
  ...
  /* exported setNotify */
  var asset = notify ? AssetPaths.FAVICON_ALERT : AssetPaths.FAVICON;
