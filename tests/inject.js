...
const TEST_MESSAGES = {
  ...
  "RESUB3": "@badge-info=subscriber/2;badges=subscriber/0,premium/1;color=#8A2BE2;display-name=Feevey;emotes=88:0-7;flags=;id=8f21ff23-7bd1-43ac-a495-5fc90993406f;login=feevey;mod=0;msg-id=resub;msg-param-cumulative-months=2;msg-param-months=0;msg-param-should-share-streak=1;msg-param-streak-months=1;msg-param-sub-plan-name=Channel\sSubscription\s(dwangoAC);msg-param-sub-plan=1000;room-id=70067886;subscriber=1;system-msg=Feevey\ssubscribed\sat\sTier\s1.\sThey've\ssubscribed\sfor\s2\smonths,\scurrently\son\sa\s1\smonth\sstreak!;tmi-sent-ts=1558901509182;user-id=194719931;user-type= :tmi.twitch.tv USERNOTICE #dwangoac :PogChamp",
